...
class SemanticScholarAPI:
    ...
    def __init__(self, api_key=os.environ.get("S2_API_KEY")) -> None:
        ...
        #self.base_url = "https://api.semanticscholar.org/graph/v1/snippet/search"
        self.base_url = "https://api.semanticscholar.org/graph/v1/"
        self.paper_url = "https://api.semanticscholar.org/graph/v1/paper"
        self.snippet_url = "https://api.semanticscholar.org/graph/v1/snippet"
